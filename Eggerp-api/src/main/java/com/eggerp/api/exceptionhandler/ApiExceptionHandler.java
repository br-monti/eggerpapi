...
import com.eggerp.domain.exception.EntityNotFoundException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handleValidationInternal(Exception ex, HttpHeaders headers,
		...
		ProblemType problemType = ProblemType.INVALIDY_DATA;
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(
		...
		ProblemType problemType = ProblemType.INVALIDY_PARAMETER;
	...
	public ResponseEntity<?> handleNegocio(TransactionalException ex, WebRequest request) {

		HttpStatus status = HttpStatus.BAD_REQUEST;
		ProblemType problemType = ProblemType.TRANSACTIONAL_ERROR;
		String detail = ex.getMessage();
